...
'.section{padding-block:clamp(5rem,9vw,9rem)}.section--black{background:var(--page-bg)}.section--surface{background:var(--surface-bg)}.section--grey{background:var(--grey-bg)}\n' +
...
'.stats-band{background:var(--grey-bg);border-top:1px solid var(--border-grey);border-bottom:1px solid var(--border-grey);padding-block:2.5rem;position:relative;z-index:10}\n' +
...
'.stats-band__divider{width:1px;height:40px;background:var(--border-grey)}\n' +
...
'.services__grid{display:grid;grid-template-columns:repeat(3,1fr);gap:1px;background:var(--border-grey);border:1px solid var(--border-grey);border-radius:var(--radius-lg);overflow:hidden}\n' +
...
'.service-card{background:var(--card-grey);padding:2.25rem 2rem;transition:background var(--t-fast)}.service-card:hover{background:#2c322c}\n' +
...
'.why__visual{position:relative;border-radius:var(--radius-xl);overflow:hidden;border:1px solid var(--border-col);background:var(--card-bg)}\n' +
...
'.model-card{background:var(--card-grey);border:1px solid var(--border-grey);border-radius:var(--radius-lg);padding:2rem 1.75rem;transition:border-color var(--t-fast),transform var(--t-slow) var(--ease-out)}\n' +
...
'  </div></div>\n' +
'</div>\n' +
'<section class="section section--black" id="about" aria-labelledby="about-h">\n' +
...
'  </div></div>\n' +
'</section>\n' +
'<section class="section section--grey" id="services" aria-labelledby="services-h">\n' +
'  <div class="container">\n' +
...
'  </div>\n' +
'</section>\n' +
'<section class="section section--black" id="how-we-work" aria-labelledby="why-h">\n' +
...
'  </div></div>\n' +
'</section>\n' +
'<section class="section section--grey" id="engagement" aria-labelledby="engagement-h">\n' +
'  <div class="container">\n' +
'    <div class="sec-header">\n' +
'      <div class="green-bar"></div>\n' +
...
'  </div>\n' +
'</div>\n' +
'<section class="section section--surface" id="contact" aria-labelledby="contact-h">\n' +
