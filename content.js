...
'.why__visual{position:relative;border-radius:var(--radius-xl);overflow:hidden;border:1px solid var(--border-col);background:var(--stats-band-alt)}\n' +
